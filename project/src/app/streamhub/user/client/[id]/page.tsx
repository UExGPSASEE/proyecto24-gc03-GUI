...
export default async function ContentPage(props: { params: Promise<{ id: string }> }) {
    ...
    const apiUrl = `http://localhost:8082/StreamHub/clientes/${params.id}`;
        ...
        <div className="content-page">
            ...
            <div className="gridcontainer">
                ...
                <div className="botonesEdicion">
                    ...
                    <a href={`http://localhost:3000/streamhub/user/client/updateUser/${params.id}`}>
                        <svg height="70" width="70" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 512 512">
                            <path
                    ...
                    <a href={`http://localhost:3000/streamhub/user/client/deleteUser/${params.id}`}>
