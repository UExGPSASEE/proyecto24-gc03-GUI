...
const ManagerProfilePage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const apiUrl = `${Config.USUARIOS_URL}/StreamHub/gestor/${id}`;
    ...
    return (
        <div className="content-page">
            <nav id="header">
                ...
                <div className="TextLogo">StreamHub - Gestor</div>
            ...
            <div className="gridcontainer">
                ...
                <div className="botonesEdicion">
                    <a href={`http://gui:8080/streamhub/user/manager/updateUser/${id}`}>
                    ...
                    <a href={`http://gui:8080/streamhub/user/manager/deleteUser/${id}`}>
